      ...
      <div className="mx-auto max-w-4xl space-y-6">
        <header className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm border-slate-200 bg-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-[#0A2540] text-[#0A2540]">محفظتي</h1>
        ...
        <EmptyState
          icon={Wallet}
          title="لا توجد معاملات مالية حالياً"
          description="بعد ربط المحفظة هتظهر هنا العمليات والرصيد بشكل مباشر."
